...
# Your code here
theta, theta_0 = p1.pegasos(data[0], data[1], 25, 0.01)
y_hat = p1.classify(test_bow_features, theta, theta_0)
print("Best method accuracy: {:.4f}".format(p1.accuracy(y_hat, test_labels)))
