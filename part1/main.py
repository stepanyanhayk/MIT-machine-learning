...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    train_y_mod3, test_y_mod3 = update_y(test_y, test_y)
...
# print("error rate for temp_parameter=0.5", run_softmax_on_MNIST(temp_parameter=0.5))
# print("error rate for temp_parameter=1.0", run_softmax_on_MNIST(temp_parameter=1.0))
# print("error rate for temp_parameter=2.0", run_softmax_on_MNIST(temp_parameter=2.0))
...
# print("error rate for softmax on mod3:", run_softmax_on_MNIST_mod3(temp_parameter=1))
...
# print("test error for pca: ", test_error)
...
print("test error for pca10: ", test_error)
